...
#    my_account: "My Account"
    ...
    facebook: "Facebook"
     twitter: "Twitter"
     create_a_class: "Δημιουργήστε μια τάξη!"
     other: "Άλλο"
     learn_to_code: "Μάθετε να γράφετε κώδικα!"
     toggle_nav: "Πλοήγηση"
     jobs: "Θέσεις εργασίας"
     schools: "Σχολεία"
     educator_wiki: "Το Wiki των εκπαιδευτών"
#    get_involved: "Μπορείτε να συμμετέχετε!"
#    open_source: "Ανοιχτός κώδικας (GitHub)"
#    support: "Υποστήριξη"
#    faqs: "Συχνές ερωτήσεις"
#    help_pref: "Χρειάζεστε βοήθεια; Στείλτε μας email"
#    help_suff: "και θα επικοινωνήσοθμε μαζί σας!"
